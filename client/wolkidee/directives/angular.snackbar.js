...
(function(angular) {
    ...
    //snackbar service
    module.factory("snackbar", ['$rootScope',
        function($rootScope) {
    ...
    //snackbar directive
    module.directive("snackbar", ["$rootScope", "$compile", "$timeout",
        function($rootScope, $compile, $timeout) {
            ...
            return function(scope, element, attrs) {
                ...
                var snackbarRemoveDelay = attrs.snackbarRemoveDelay || 1000;
                ...
                $rootScope.$on('createSnackbar', function(event, received) {
                    ...
                    //snackbar template
                    var template = '<div class="snackbar snackbar-opened animated fadeInUp"><span class="snackbar-content">' + received.content + '</span></div>';
